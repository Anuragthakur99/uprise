...
import CourseQuizzes from "./pages/coursestudy/CourseQuizzes"
import TakeQuiz from "./pages/coursestudy/TakeQuiz"
import QuizResults from "./pages/coursestudy/QuizResults"
      ...
      {loading ? (
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/quiz" element={isAuth ? <AdminQuizzes user={user} /> : <Login />} />
            <Route path="/admin/quiz/:id" element={isAuth ? <EditQuiz user={user} /> : <Login />} />
            <Route path="/course/:courseId/quizzes" element={isAuth ? <CourseQuizzes user={user} /> : <Login />} />
            <Route path="/course/:courseId/quiz/:quizId" element={isAuth ? <TakeQuiz user={user} /> : <Login />} />
            <Route
              path="/course/:courseId/quiz/:quizId/results"
              element={isAuth ? <QuizResults user={user} /> : <Login />}
            />
          </Routes>
          <Footer />
        </BrowserRouter>
